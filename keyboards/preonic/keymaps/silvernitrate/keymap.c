...
[_QWERTY] = {
  ...
  {MO(_NUMPADFN), KC_LGUI, KC_LALT, KC_LCTL, MO(_MAC_LOWER),   KC_SPC,  KC_SPC,  MO(_MAC_RAISE),  KC_LEFT,   KC_UP,   KC_DOWN, LT(_USHIFT, KC_RIGHT)}
},

[_MAC_LOWER] = {
  {_______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______},
  {LCTL(KC_1), _______, F(45), _______, _______,  _______, _______, F(33),   F(21), F(34), _______,  KC_DEL},
  {_______, _______, _______, _______, _______, _______, _______,    F(23),   F(22),    F(24), _______, _______},
  {KC_PIPE, _______, _______, _______, _______, _______, _______,   F(12), LCTL(KC_UP),   F(13), _______, _______},
...
[_MAC_RAISE] = {
  ...
  { DSHARR, KC_LCBR, KC_RCBR, KC_PIPE, KC_BSLS, _______, _______, _______, _______,   KC_UP, KC_BSLS, _______},
...
[_STRCFT] = {
  ...
  // {KC_ESC,    KC_7,    KC_8,    KC_9,    KC_0, KC_MINS,  KC_EQL,    KC_7,    KC_8,    KC_9,    KC_0,    QWERTY},
  // {  KC_Y,    KC_U,    KC_I,    KC_O,    KC_P, KC_LBRC, KC_RBRC,    KC_U,    KC_I,    KC_O,    KC_P,    QWERTY},
  // {  KC_H,    KC_J,    KC_K,    KC_L, KC_SCLN, KC_QUOT,    KC_H,    KC_J,    KC_K,    KC_L, KC_SCLN, KC_QUOT},
  // {  KC_N,    KC_M, KC_COMM,  KC_DOT, KC_SLSH,    KC_B,    KC_N,    KC_M, KC_COMM,  KC_UP,   F(20),   MT(MOD_RSFT, KC_ENT)},
  // {  KC_B, KC_LGUI, KC_LALT, KC_SLSH, KC_LCTL, KC_RSFT, KC_RSFT,  KC_LALT,  KC_LEFT,   KC_DOWN,   KC_RIGHT, MO(_USHIFT)}
},
...
[_USHIFT] = {
  ...
  {_______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______},
  { QWERTY, QWERTY_WIN, STRCFT, _______, _______, LALT(KC_SPC), _______, _______, _______, _______, _______, _______}
},
...
bool process_record_user(uint16_t keycode, keyrecord_t *record) {
  switch (keycode) {
        ...
        case SPCSPC:
          ...
          case GLHF:
          if (record->event.pressed) {
            SEND_STRING("Good luck, have fun my friend");
          }
          return false; break;
          case GG:
          if (record->event.pressed) {
            SEND_STRING("GG, well played my dude");
          }
          return false; break;
      }
    return true;
